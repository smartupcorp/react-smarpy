...
import type AdminNavMenuItemProps from "./AdminNavMenuItemProps";
import type { BaseAdminNavMenuItemProps } from "./AdminNavMenuItemProps";

export default function AdminNavMenuItem<
  BaseComponentColorNameType extends string = ColorName,
  ComponentPropsType extends
    BaseAdminNavMenuItemProps<BaseComponentColorNameType> =
    AdminNavMenuItemProps<BaseComponentColorNameType>,
